...
describe('Function `buildCategoryTree`', () => {
  ...
  it('builds a simple tree (with a single top-level category) from raw data', () => {
    ...
    const categoryHouse: CategoryTreeNode = {
      id: '1f0bb659-659d-462e-8249-1c403304fa80',
      balance:
        (categoryHouseHoa.balance ?? 0) +
        (categoryHouseMortgage.balance ?? 0) +
        (categoryHouseRepairsAndMaintenance.balance ?? 0),
      name: 'House',
      order: 1,
      parentId: null,
      createdAt: new Date('2022-10-21T11:29:30.343Z'),
      updatedAt: new Date('2022-10-31T10:11:24.917Z'),
      children: [
        categoryHouseMortgage,
        categoryHouseHoa,
        categoryHouseRepairsAndMaintenance,
      ],
    };
  ...
  it('builds a tree with multiple top-level categories (and multiple children) from raw data', () => {
    const rawCategories: RawCategory[] = [
      {
    ...
    // Expected tree
    const clothes: CategoryTreeNode = {
      id: '0b74b558-86d1-45dc-9af5-41da2e099731',
      balance: 9500,
      name: 'Clothes',
      order: null,
    ...
    const entertainmentDisneyPlus: CategoryTreeNode = {
      id: 'c48c2c7e-9689-4954-8101-9872c5aa82a4',
      balance: 349,
      name: 'Disney+',
      order: null,
    ...
    const entertainmentHulu: CategoryTreeNode = {
      id: 'b76aa2eb-8a33-47cc-a52b-bbacd1a67d66',
      balance: 10,
      name: 'Hulu',
      order: null,
    ...
    const entertainmentNetflix: CategoryTreeNode = {
      id: '0b2c7ac5-b714-4282-adf4-062cb10fc1ff',
      balance: 1599,
      name: 'Netflix',
      order: null,
    ...
    const entertainmentPrimeVideo: CategoryTreeNode = {
      id: '8f11d859-3a25-4656-bffa-235a9d5913d4',
      balance: 0,
      name: 'Prime Video',
      order: null,
    ...
    const entertainment: CategoryTreeNode = {
      id: '8a7b038b-673d-4a45-b047-20c9ccb25e82',
      balance:
        (entertainmentDisneyPlus.balance ?? 0) +
        (entertainmentHulu.balance ?? 0) +
        (entertainmentNetflix.balance ?? 0) +
        (entertainmentPrimeVideo.balance ?? 0),
      name: 'Entertainment',
      order: null,
      parentId: null,
      createdAt: new Date('2022-10-21T11:29:30.365Z'),
      updatedAt: new Date('2022-10-21T11:29:30.365Z'),
      children: [
        entertainmentDisneyPlus,
        entertainmentHulu,
        entertainmentNetflix,
        entertainmentPrimeVideo,
      ],
    };
    ...
    const houseHoa: CategoryTreeNode = {
      id: '03eda307-6993-4dc7-a44c-8a72dc5a9c68',
      balance: 9342,
      name: 'HOA',
      order: 2,
    ...
    const houseMortgage: CategoryTreeNode = {
      id: '579912cd-a26d-41b5-8cdb-17addc41dc52',
      balance: 186869,
      name: 'Mortgage',
      order: 1,
    ...
    const houseRepairsAndMaintenance: CategoryTreeNode = {
      id: '3b11b8da-a46c-4716-bb04-7c72a855bfcd',
      balance: 4999,
      name: 'Repairs & maintenance',
      order: 3,
    ...
    const house: CategoryTreeNode = {
      id: '1f0bb659-659d-462e-8249-1c403304fa80',
      balance:
        (houseHoa.balance ?? 0) +
        (houseMortgage.balance ?? 0) +
        (houseRepairsAndMaintenance.balance ?? 0),
      name: 'House',
      order: 1,
      parentId: null,
      createdAt: new Date('2022-10-21T11:29:30.343Z'),
      updatedAt: new Date('2022-10-31T10:11:24.917Z'),
      children: [houseMortgage, houseHoa, houseRepairsAndMaintenance],
    };

    const kids: CategoryTreeNode = {
      id: 'e28c6f53-3a3f-435f-939d-77501abf7554',
      balance: -13624,
      name: 'Kids',
      order: null,
